///////////////////////////////////////////////////////////////////////////
//// Driver for AD9832 DDS chip from Analog Devices                    
///////////////////////////////////////////////////////////////////////////
...
static const char *TAG = "AD9832_TX";
...
//*****************************************************************
// converts a frequency in Hz to the 9832 register value

uint32_t ConvertFrequency(uint32_t temp){
   uint32_t c;
   c=(uint32_t)(temp/5.8207660913467e-3);
   return(c);
}


//*****************************************************************
// sends the 32bit word passed, to the FREQ0 Reg of the 9832
...
//*****************************************************************
// send the required commands to initialise the 9832
