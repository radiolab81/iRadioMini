...
4. Displayd mit lvgl-Unterstützung aktivieren.

4.1 In iRadioMini/main/CMakeLists.txt den Eintrag "./modules/display/lvgl/displayd_lvgl.c" hinzufügen.
...
set(COMPONENT_SRCS "iRadioMini.c" 
		   ...
		   "./modules/display/lvgl/displayd_lvgl.c")
...
4.2  in iRadioMini.c einen displayd_lvgl Task starten.
...
     #include "modules/display/lvgl/displayd_lvgl.h"
...

     TaskHandle_t xdisplaydHandle = NULL;
     xTaskCreate( displayd_lvgl, "displayd", 4096, NULL , tskIDLE_PRIORITY, &xdisplaydHandle );
