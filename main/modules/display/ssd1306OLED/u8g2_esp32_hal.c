...
uint8_t u8g2_esp32_i2c_byte_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr) {
	...
	switch(msg) {
		...
		case U8X8_MSG_BYTE_INIT: {
		    ...
		    conf.clk_flags = 0; // added in IDF 4.3 -> remove when you build with IDF < V4.3
                        ESP_LOGI(TAG, "remove \"conf.clk_flags=0\" in u8g2_esp32_hal.c when build with IDF < V4.3");
