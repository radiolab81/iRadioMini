...
#define ZEIGERANSCHLAG_LINKS 80
#define ZEIGERANSCHLAG_RECHTS 310

#define FPS 20

#define SENDERABSTAND (ZEIGERANSCHLAG_RECHTS-ZEIGERANSCHLAG_LINKS)/channels_in_list

static const char *TAG = "DISPLAYD_LVGL_SKALE";
int old_ch = -1;
...
/////////////////////////////////// END: lib & driver init //////////////////////////////////////////
   ...
   lv_obj_align(img_zeiger, LV_ALIGN_TOP_LEFT, ZEIGERANSCHLAG_LINKS, 0); 
   ...
   lv_obj_align(label_url, LV_ALIGN_BOTTOM_LEFT, 0, 0);
       ...
       if( xQueueReceive( xDisplaydQueue, &( rxMsg ), ( TickType_t ) 10 )  )
		...
		ESP_LOGI(TAG, "actual channel num: %i",rxMsg->uciChannelNum); 
		  ...
		  // bewege Skalenzeigen bis zur neuen Station
	             ...
	             lv_obj_align(img_zeiger, LV_ALIGN_TOP_LEFT, pos_zeiger_now, 0);
		   }
